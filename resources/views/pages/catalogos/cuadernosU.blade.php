...
@section('content')
    ...
    <section class="p-6 mt-6 flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1 mt-6 lg:mt-0">
            <div class="hidden lg:block">
                <h1 class="text-[#004A8E] text-3xl font-bold">Libros CUADERNOS UNIVERSITARIOS</h1>
            </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500">CUADERNOS UNIVERSITARIOS</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <script>
        ...
        function loadBooksLeeUnach(){
            $.ajax({
                url: '/api/catalogo/libros-CUADERNOSUNIVERSITARIOS',
                method: 'GET',
